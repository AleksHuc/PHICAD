...
public class CFNode {
    ...
    CFNode(int maxNodeEntries, int distanceFunction, double distanceThreshold, boolean leafStatus, double lambda, double delta, int checkStep, int maxBins, int sizeOfBin, double normalClusterThreshold, AtomicLong idCounter, String name) {
...
//                    }
    ...
    CF createCFForNode() {
        CF newCF = new CF(this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, -1L, this.name);
    ...
    private CF[] splitCF(CF cf, AtomicInteger nCFNodes){
        ...
        CF newCF1 = new CF(this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter.getAndIncrement(), this.name);
        CFNode newCFNode1 = new CFNode(this.maxNodeEntries, this.distanceFunction, this.distanceThreshold, oldCFNode.isLeafStatus(), this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter, this.name);
        newCF1.setChild(newCFNode1);

        CF newCF2 = new CF(this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter.getAndIncrement(), this.name);
        CFNode newCFNode2 = new CFNode(this.maxNodeEntries, this.distanceFunction, this.distanceThreshold, oldCFNode.isLeafStatus(), this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter, this.name);
...
//        }
    ...
    private void mergingRefinement(CF[] splitPair, AtomicInteger nCFNodes) {
        ...
        if ((oldCFNode1CFList.size() + oldCFNode2CFList.size()) > this.maxNodeEntries) {
            ...
            CF newCF = new CF(this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter.getAndIncrement(), this.name);
            CFNode newCFNode = new CFNode(this.maxNodeEntries, this.distanceFunction, this.distanceThreshold, oldCFNode1.isLeafStatus(), this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter, this.name);
            ...
            if (oldCFNode1.isLeafStatus() && oldCFNode2.isLeafStatus()) {
                ...
                CFNode dummy = new CFNode(0, 0, 0, true, this.lambda, this.delta, this.checkStep, this.maxBins, this.sizeOfBin, this.normalClusterThreshold, this.idCounter, name);
