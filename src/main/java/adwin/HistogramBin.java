...
public class HistogramBin {
     ...
     * @return null if the maximum length of bin is not achieved or TotalVariance object with the total and variance of the oldest two totals and variances in the bin otherwise.
     */
